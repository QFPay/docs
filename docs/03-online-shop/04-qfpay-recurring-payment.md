...
| --------------------------------------------- |
| [Customer](#customer)                         |
| [Payment Token](/docs/03-online-shop/03-paymentelement.md) |
| [Product](#product)                           |
...
3. [**Integrate with our element service**](/docs/03-online-shop/03-paymentelement.md) and use elements.createEnhance() and payment.pay() for token creation page. Then use `customer_id` and card information to create token and get `token_id`
