...
# FPS App-to-App Integration Guide
...
<Link href="/img/fps_app-call-app_en.jpeg" target="_blank">![FPS App-call-app process-flow](@site/static/img/fps_app-call-app_en.jpeg)</Link>

## 1. Retrieve Payment Parameters

**API Endpoint**: `/trade/v1/payment`
**Method**: `POST`
**PayType**: `800210`
